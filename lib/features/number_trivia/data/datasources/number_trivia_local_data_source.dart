...
abstract class NumberTriviaLocalDataSource {
  /// Gets the cached [NumberTriviaModel] which was gotten
...
class NumberTriviaLocalDataSourceImpl implements NumberTriviaLocalDataSource {
  ...
  Future<void> cacheNumberTrivia(NumberTriviaModel triviaToCache) async {
    var jsonString = json.encode(triviaToCache.toJson());
    return sharedPreferences.setString(CACHED_NUMBER_TRIVIA, jsonString);
  }

  @override
  Future<NumberTriviaModel> getLastNumberTrivia() async {
    var jsonString = sharedPreferences.getString(CACHED_NUMBER_TRIVIA);
    if (jsonString != null) {
